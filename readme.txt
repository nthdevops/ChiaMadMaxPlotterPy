Notas:
  Para as chaves farmer.key e pool.key faça o comando `chia.exe keys show` no diretório daemon da chia.
  temp.dir precisa de aproximadamente 330 GiB de espaço
...
Uso:
  ...
  pool.key (Pegar a chave pública da pool key)